...
?>
    <div class="container container-fluid">            
        <h2 class="text-center">Crea la tua attività</h2>
        <div class="row">
            <div class="col-md-12 col-lg-12 col-sm-12">
                <form method="POST" action="action/crea_attività.php" enctype="multipart/form-data">
                    ...
                    <div class="row">
                            ...
                            <div class="form-group">
                                <div class="avatar-upload">
                                    <div class="avatar-preview">
                                        <div id="imagePreview" style="background-image: url('../../img/activity_picture/background.jpg')"></div>
                                        </div>
                        ...
                        <div class="col-md-4 col-lg-4">
                            ...
                            <div class="form-group row">
                                ...
                                <input class="form-control form-control-sm" type="text" name="titolo" required>
                            </div>
                            <div class="row">
                                <div class="form-group">
                                <label class="control-label"></label>
                                    <select required class="form-control form-control-sm" name="tipologia">
                            ...
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    <input class="form-control form-control-sm"" list="cities" name="citta" required>
                                    <datalist id="cities">
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-md-5 col-lg-5">
                            ...
                            <textarea class="form-control form-control-lg" name="descrizione" style="font-size: medium;"required></textarea>
                        </div>
                        <div class="col-sm-5 col-md-4 col-lg-2 offset-md-2">
                            <label class="control-label">Lingua Parlata</label>
                            <div class="form-group">
                                <select class="js-example-templating form-control form-control-sm" name="lingua_parlata" id="select" required>
                        ...
                        <!-- <div class="col-sm-5 col-md-4 col-lg-3 offset-md-1 form-inline ">
                                <label>Max Partecipanti
                                <select class="form-control form-control-sm" name="limite_partecipanti" style="margin-left:0.5rem;" required>
                    ...
                    <div class="row">
                        <div class="form-group" style="margin:auto;"><input style="margin-top:1rem"type="submit" class="btn btn-primary btn-block btn-lg" value="Imposta Punto di Incontro"/></div>
                    </div>
                </form>
            </div>
        </div>
