<?php
    ...
    $user_data = $_SESSION['utente'];
        ...
        $old_date = $_SESSION['date_richieste']['data_attivita'];
        $new_date = strtr($old_date, '/', '-');
        $final_date = date("d-m-Y", strtotime($new_date));
...
<html>
    ...
    <body style="background-color: #f8f9fa">
        ...
        <div class="container">
            <h2 class="text-center">Richieste per <?php echo $_SESSION['riproponi']['titolo']?></h2>
            <h3 class="text-center">Orario: <?php echo $final_date. "  " .$_SESSION['date_richieste']['ora_inizio']?></h3>
            ...
            <div class="row line">
                ...
                <div class="col-4 col-sm-4 col-md-2 col-lg-2"><strong>Stato Richiesta</strong></div>

            </div>
            <?php
            if(isset($_SESSION['richieste'])){
                include "globetrotter_table.php";
            }
            ?>
        </div>
