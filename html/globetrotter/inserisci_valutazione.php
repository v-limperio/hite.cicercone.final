...
<body style="background-color: #f8f9fa">
    ...
    <a href="action/call_elenco_valutazioni.php"><-Le mie valutazioni</a> 
        <h2 class="text-center">Valuta <?php echo $_SESSION['valutazione'][$_POST['id']]['attivita']['titolo']?></h2>
        <div class="row">
            <div class="col-md-12 col-lg-12 col-sm-12">
                <form method="POST" action="action/call_inserisci_valutazione.php" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-sm-5 col-md-4 col-lg-4">
                            ...
                            <select required class="form-control form-control-sm" name="voto">
                    ...
                    <div class="row">
                        <div class="col-sm-5 col-md-12 col-lg-12">
                            ...
                            <textarea class="form-control form-control-lg" name="recensione" style="font-size: medium;" required></textarea>
                        </div>
                    </div>

                    <div class="row">
                        <div class="form-group" style="margin:auto;">
                            <input style="margin-top:1rem" type="submit" class="btn btn-primary btn-block btn-lg" value="Inserisci Valutazione" />
                        </div>
                    </div>
                </form>
            </div>
