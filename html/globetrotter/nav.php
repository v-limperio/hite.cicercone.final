<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="collapse navbar-collapse justify-content-end" id="navbarNavDropdown">
        ...
        <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link" id="partecipazioni" href="action\call_visualizza_richieste.php">Le mie Richieste</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" id="valutazioni" href="action\call_elenco_valutazioni.php">Le mie Valutazioni</a>
            </li>
